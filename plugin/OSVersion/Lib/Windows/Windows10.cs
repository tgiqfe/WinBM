    ...
    internal class Windows10
    {
        public static OSVersionInfo Create1507(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1507",
                Serial = 1507,
                Alias = new string[] { "Released in July 2015", "ReleasedinJuly2015", "Threshold 1", "Threshold1", "v1507" },
                Version = "10.0.10240",
                Edition = edition,
        ...
        public static OSVersionInfo Create1511(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1511",
                Serial = 1511,
                Alias = new string[] { "November Update", "NovemberUpdate", "Threshold 2", "Threshold2", "v1511" },
                Version = "10.0.10586",
                Edition = edition,
        ...
        public static OSVersionInfo Create1607(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1607",
                Serial = 1607,
                Alias = new string[] { "Anniversary Update", "AnniversaryUpdate", "Redstone 1", "Redstone1", "v1607" },
                Version = "10.0.14393",
                Edition = edition,
        ...
        public static OSVersionInfo Create1703(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1703",
                Serial = 1703,
                Alias = new string[] { "Creators Update", "CreatorsUpdate", "Redstone 2", "Redstone2", "v1703" },
                Version = "10.0.15063",
                Edition = edition,
        ...
        public static OSVersionInfo Create1709(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1709",
                Serial = 1709,
                Alias = new string[] { "Fall Creators Update", "FallCreatorsUpdate", "Redstone 3", "Redstone3", "v1709" },
                Version = "10.0.16299",
                Edition = edition,
        ...
        public static OSVersionInfo Create1803(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1803",
                Serial = 1803,
                Alias = new string[] { "April 2018 Update", "April2018Update", "Redstone 4", "Redstone4", "v1803" },
                Version = "10.0.17134",
                Edition = edition,
        ...
        public static OSVersionInfo Create1809(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1809",
                Serial = 1809,
                Alias = new string[] { "October 2018 Update", "October2018Update", "Redstone 5", "Redstone5", "v1809" },
                Version = "10.0.17763",
                Edition = edition,
        ...
        public static OSVersionInfo Create1903(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1903",
                Serial = 1903,
                Alias = new string[] { "May 2019 Update", "May2019Update", "19H1", "v1903" },
                Version = "10.0.18362",
                Edition = edition,
        ...
        public static OSVersionInfo Create1909(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "1909",
                Serial = 1909,
                Alias = new string[] { "November 2019 Update", "November2019Update", "19H2", "v19H2" },
                Version = "10.0.18636",
                Edition = edition,
        ...
        public static OSVersionInfo Create2004(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "2004",
                Serial = 2004,
                Alias = new string[] { "May 2020 Update", "May2020Update", "20H1", "v20H1" },
                Version = "10.0.19041",
                Edition = edition,
        ...
        public static OSVersionInfo Create20H2(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "20H2",
                Serial = 2009,
                Alias = new string[] { "October 2020 Update", "October2020Update", "v20H2" },
                Version = "10.0.19042",
                Edition = edition,
        ...
        public static OSVersionInfo Create21H1(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "21H1",
                Serial = 2103,
                Alias = new string[] { "May 2021 Update", "May2021Update", "21H1" },
                Version = "10.0.19043",
                Edition = edition,
        ...
        public static OSVersionInfo Create21H2(Edition? edition)
        {
            return new OSVersionInfo()
            {
                ...
                VersionName = "21H2",
                Serial = 2110,
                Alias = new string[] { "November 2021 Update", "November2021Update", "v21H2" },
                Version = "10.0.19044",
                Edition = edition,
                ReleaseDate = new DateTime(2021, 11, 16),
                EndSupportDate = edition switch
                {
                    Edition.Home => new DateTime(2023, 6, 13),
                    Edition.Pro => new DateTime(2023, 6, 13),
                    Edition.Enterprise => new DateTime(2024, 6, 11),
                    Edition.Education => new DateTime(2024, 6, 11),
                    Edition.ProEducation => new DateTime(2024, 6, 11),
                    Edition.EnterpriseLTSB => null,
                    Edition.EnterpriseLTSC => new DateTime(2032, 1, 13),
                    _ => null
                },
                IsServer = false,
                IsEmbedded = false
